...
echo "Fecha Inicio novipaud.exe 1 : `date`"         >> $LOG 2>&1
wm -r wmaudi1.txt  novipaud.exe
echo "Fecha FIN    novipaud.exe 1 : `date`"         >> $LOG 2>&1
sleep 5

echo "Fecha Inicio novipaud.exe 3 : `date`"         >> $LOG 2>&1
wm -r wmaudi3.txt  novipaud.exe
echo "Fecha FIN    novipaud.exe 3 : `date`"         >> $LOG 2>&1
sleep 5

echo "Fecha Inicio novipaud.exe 5 : `date`"         >> $LOG 2>&1
wm -r wmaudi5.txt  novipaud.exe
echo "Fecha FIN    novipaud.exe 5 : `date`"         >> $LOG 2>&1
sleep 5
