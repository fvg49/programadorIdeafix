...
#define TIT_FINIP		"Fecha de Inicio del Puesto"
#define	TIT_HINIP		"Hora de Inicio del Puesto"
#define TIT_FFINP		"Fecha de Fin del Puesto"
#define TIT_HFINP		"Hora de Fin del Puesto"
#define TIT_ABM			"ABM"
...
#define TIT_MOV			"Mov."
#define TIT_CPUA		"Cant. Puesto Alta"
#define TIT_PUESTOA		"Puesto Alta"
#define TIT_DPUESTOA	"Descrip. Puesto Alta"
#define TIT_CATEA		"Categoria Alta"
#define TIT_HORINIA		"Hora Ini. Alta"
#define TIT_HORFINA		"Hora Fin. Alta"
#define TIT_DIASA		"Días Alta"
#define TIT_SUBREGA		"Subregimen Alta"
#define TIT_DA          "D"
...
/* Programa principal */
wcmd(varserv, 1.1 07/12/21)
{
	fm_cmd cmd;

	fm0 = OpenForm  ("varserv", FM_EABORT);
...
void ArchivarPto()
{
    ...
    // titulos                        0                   0                   0                   0                   0                   0
	fprintf (fp, "%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s\n",
		TIT_CLI,		R_SEPAR,	
		TIT_DCLI,		R_SEPAR,
		TIT_OBJ,        R_SEPAR,    
		TIT_DOBJ,		R_SEPAR,
		TIT_FINIP,		R_SEPAR, //NUEVO
		TIT_HINIP,		R_SEPAR, //NUEVO
		TIT_FFINP,		R_SEPAR, //NUEVO
		TIT_HFINP,		R_SEPAR, //NUEVO
		TIT_ABM,		R_SEPAR, //NUEVO
		TIT_CPU,		R_SEPAR,    
		TIT_PUESTO,     R_SEPAR,    
		TIT_DPUESTO,	R_SEPAR,
		TIT_CATEG,      R_SEPAR,
		...
		TIT_TOTHS,  	R_SEPAR,
		TIT_CANV,	  	R_SEPAR,
		TIT_MOV,	  	R_SEPAR, //NUEVO
		TIT_CPUA,		R_SEPAR, //NUEVO
		TIT_PUESTOA,    R_SEPAR, //NUEVO
		TIT_DPUESTOA,	R_SEPAR, //NUEVO
		TIT_CATEA,		R_SEPAR, //NUEVO
		TIT_HORINIA,   	R_SEPAR, //NUEVO
		TIT_HORFINA,   	R_SEPAR, //NUEVO
		TIT_DIASA,   	R_SEPAR, //NUEVO
		TIT_SUBREGA,   	R_SEPAR, //NUEVO
		TIT_DA);                 //NUEVO
	...
	for (epuesto = pripuesto; epuesto < upuesto; epuesto ++) {
		if (!epuesto->cpue)
			...
			sprintf(dias,"%s-%s-%s-%s-%s-%s-%s",
 			...
 			fprintf (fp, "%ld%s%s%s%d%s%s%s%s%s%s%s%s%d%s%d%s%s%s%d%s%.1T%s%.1T%s%s%s%s%s%s%s%s%s%.2f%s%.2f%s%.2f%s%.2f%s%.2f%s%s%s%s%s%s%s%s - - - - - - %s%s\n",
					...
					R_SEPAR,R_SEPAR,R_SEPAR,R_SEPAR,R_SEPAR,
...
void AbrirSalida()
{
	if (!strcmp(FmSFld(fm0, SALIDA), "A")) {
		...
		rp0 = OpenReport("varserv", RP_EABORT|RP_NOBEGIN);
	...
	switch (fno) {
 	case NOMARCH:
		if (*FmSFld (fm, SALIDA) == 'A' && FmIsNull (fm, NOMARCH))
			FmSetFld (fm, NOMARCH, "varserv.txt");
		break;
	case CLID:
	   	InicClientesXusr();
    	break;
